  ...
  return (
    <div className="relative w-full bg-zinc-950 text-white overflow-hidden font-sans">
      <style>{`
        ...
        .g-fade-in  { animation: fadeSlideIn 0.8s ease-out forwards; opacity: 0; }
        .g-marquee  { animation: marqueeSkills 36s linear infinite; }
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&w=1920&q=80)",
          opacity: 0.35,
          maskImage:
            "linear-gradient(180deg, transparent, black 5%, black 72%, transparent 100%)",
          WebkitMaskImage:
            "linear-gradient(180deg, transparent, black 5%, black 72%, transparent 100%)",
        }}
      />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pt-24 pb-12 sm:px-6 md:pt-32 md:pb-20 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            {/* Badge */}
            <div className="g-fade-in delay-100">
            ...
            <h1
              className="g-fade-in delay-200 leading-[0.92] tracking-tighter"
              style={{
            ...
            {/* Roles — Syne uppercase */}
            <div className="g-fade-in delay-300 space-y-1">
              <p
                style={{
            ...
            {/* CTA Buttons */}
            <div className="g-fade-in delay-400 flex flex-col sm:flex-row gap-4">
              <button
                onClick={() =>
                  document
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
            ...
            {/* Stats / Profile Card */}
            <div className="g-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <div className="text-3xl font-bold tracking-tight text-white">10+</div>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-400">AI & Full-Stack Expertise</span>
                    <span className="text-white font-medium">92%</span>
                  </div>
                  <div className="h-2 w-full overflow-hidden rounded-full bg-zinc-800/50">
                    <div className="h-full w-[92%] rounded-full bg-gradient-to-r from-white to-zinc-400" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <StatItem value="AI"  label="Focused"  />
                  <div className="w-px h-full bg-white/10 mx-auto" />
            ...
            {/* Skills Marquee Card */}
            <div className="g-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-8 backdrop-blur-xl">
              <h3 className="mb-6 px-8 text-sm font-medium text-zinc-400">Tech Stack</h3>
              <div
              ...
              >
                <div className="g-marquee flex gap-12 whitespace-nowrap px-4">
